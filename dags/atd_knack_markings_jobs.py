...
with DAG(
    dag_id="atd_knack_markings_jobs",
    description="Loads markings jobs records from Knack to Postgrest to AGOL",  # noqa:E501
    ...
    t1 = DockerOperator(
        task_id=f"markings_jobs_{SCRIPT_TASK_1}",
        image=DOCKER_IMAGE,
        api_version="auto",
        auto_remove=True,
    ...
    t2 = DockerOperator(
        task_id=f"markings_jobs_{SCRIPT_TASK_2}",
        image=DOCKER_IMAGE,
        api_version="auto",
        auto_remove=True,
    ...
    t3 = DockerOperator(
        task_id=f"markings_jobs_{SCRIPT_TASK_3}",
        image=DOCKER_IMAGE,
        api_version="auto",
        auto_remove=True,

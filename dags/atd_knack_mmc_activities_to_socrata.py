...
@dag(
    ...
    description="Load mmc activities from Knack to Postgres to Socrata",
    default_args=DEFAULT_ARGS,
    schedule="20 6 * * *" if DEPLOYMENT_ENVIRONMENT == "production" else None,
    tags=["repo:atd-knack-services", "knack", "socrata", "data-tracker"],
    catchup=False,
    doc_md="""
## MMC activities (Knack to PostgREST and Socrata)

Loads MMC activity records from Knack Data Tracker (app 'data-tracker', container
...
atd_knack_mmc_activities_to_socrata()

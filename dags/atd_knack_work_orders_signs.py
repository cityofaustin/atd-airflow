...
default_args = {
    "owner": "airflow",
    "description": "Load work orders markings (view_3107) records from Knack to Postgrest to Socrata",  # noqa:E501
...
with DAG(
    dag_id="atd_knack_work_orders_signs",
    ...
    t1 = DockerOperator(
        task_id="atd_knack_work_orders_signs_to_postgrest",
        image=docker_image,
        api_version="auto",
        auto_remove=True,

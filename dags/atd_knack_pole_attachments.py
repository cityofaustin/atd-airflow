...
default_args = {
    "owner": "airflow",
    "description": "Load pole attachments (view_1597) records from Knack to Postgrest to AGOL and Socrata",  # noqa:E501
...
with DAG(
    dag_id="atd_knack_pole_attachments",
    ...
    t1 = DockerOperator(
        task_id="atd_knack_pole_attachments_to_postgrest",
        image=docker_image,
        api_version="auto",
        auto_remove=True,
    ...
    t2 = DockerOperator(
        task_id="atd_knack_pole_attachments_to_socrata",
        image=docker_image,
        api_version="auto",
        auto_remove=True,
    ...
    t3 = DockerOperator(
        task_id="atd_knack_pole_attachments_to_agol",
        image=docker_image,
        api_version="auto",
        auto_remove=True,

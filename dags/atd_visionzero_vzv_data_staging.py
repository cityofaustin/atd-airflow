...
hasura_env_vars = Variable.get("atd_visionzero_cris_staging", deserialize_json=True)
vzv_data_query = Variable.get("atd_visionzero_vzv_query_staging", deserialize_json=True)
...
#
dag = DAG(
    dag_id="atd_visionzero_vzv_data_staging",

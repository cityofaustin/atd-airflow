...
Gets master agreement data from a database, places it in an S3 bucket, then moves it along to Knack and socrata.
...
with DAG(
    ...
    schedule="28 7 * * *" if DEPLOYMENT_ENVIRONMENT == "production" else None,

...
with DAG(
    ...
    t1 = DockerOperator(
        ...
        image=docker_image,
        auto_remove=True,
        command=f"./atd-knack-services/services/records_to_postgrest.py -a {app_name} -c {container} -d 1970-01-01 {date_filter_arg}",
    ...
    t2 = DockerOperator(
        ...
        image=docker_image,
        auto_remove=True,
        command=f"./atd-knack-services/services/records_to_socrata.py -a {app_name} -c {container} -d 1970-01-01 {date_filter_arg}",
        environment=env_vars,
        tty=True,
        mount_tmp_dir=False,
    )
    ...
    t3 = DockerOperator(
        ...
        image=docker_image,
        auto_remove=True,
        command=f"./atd-knack-services/services/records_to_agol.py -a {app_name} -c {container} -d 1970-01-01 {date_filter_arg}",
        environment=env_vars,
        tty=True,
        mount_tmp_dir=False,
    )

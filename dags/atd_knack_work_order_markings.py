...
default_args = {
    "owner": "airflow",
    "description": "Load work orders markings (view_3099) records from Knack to Postgrest to Socrata",  # noqa:E501
...
with DAG(
    dag_id="atd_knack_work_order_markings",
    ...
    t1 = DockerOperator(
        task_id="atd_knack_work_order_markings_to_postgrest",
        image=docker_image,
        api_version="auto",
        auto_remove=True,
    ...
    t2 = DockerOperator(
        task_id="atd_knack_work_order_markings_to_socrata",
        image=docker_image,
        api_version="auto",
        auto_remove=True,

...
with DAG('atd_visionzero_cr3_staging', default_args=default_args, schedule_interval="0 */12 * * *", catchup=False) as dag:
        #
        # Task: docker_command
        ...
        t1 = DockerOperator(
                ...
                network_mode="bridge",
                environment=Variable.get("atd_visionzero_cr3_staging", deserialize_json=True)
        )

...
with DAG(
    ...
    description="Loads markings materials records from Knack to Postgrest to AGOL",  # noqa:E501
    ...
    t1 = DockerOperator(
        task_id=f"markings_materials_{SCRIPT_TASK_1}",
        image=DOCKER_IMAGE,
        api_version="auto",
        auto_remove=True,
    ...
    t2 = DockerOperator(
        task_id=f"markings_materials_{SCRIPT_TASK_2}",
        image=DOCKER_IMAGE,
        api_version="auto",
        auto_remove=True,

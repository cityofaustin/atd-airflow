...
with DAG(
    dag_id="atd_knack_edp_school_beacons",
    description="Load school beacons (view_3898) records from Knack to Postgrest to Socrata",
    default_args=DEFAULT_ARGS,
    schedule_interval="28 5 * * *" if DEPLOYMENT_ENVIRONMENT == "production" else None,
    ...
    t1 = DockerOperator(
        task_id="atd_knack_edp_school_beacons_to_postgrest",
        image=docker_image,
        auto_remove=True,
    ...
    t2 = DockerOperator(
        task_id="atd_knack_edp_school_beacons_to_socrata",
        image=docker_image,
        auto_remove=True,

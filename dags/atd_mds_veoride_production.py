...
default_args = {
        'owner'                 : 'airflow',
        'description'           : 'Gathers MDS data from VeoRide',
...
with DAG(f"atd_mds_{mds_provider}_production", default_args=default_args, schedule_interval="30 * * * *", catchup=False) as dag:
        #

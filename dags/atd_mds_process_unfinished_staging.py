...
with DAG(
    ...
    lime = DockerOperator(
        ...
        api_version="auto",
        auto_remove=True,
        command=f"./provider_runtool.py --provider 'lime' --time-max '{time_max}' --time-min '{time_min}' --incomplete-only",
    ...
    jump = DockerOperator(
        ...
        api_version="auto",
        auto_remove=True,
        command=f"./provider_runtool.py --provider 'jump' --time-max '{time_max}' --time-min '{time_min}' --incomplete-only",
        docker_url="tcp://localhost:2376",
        network_mode="bridge",
        environment=environment_vars,
    )
    ...
    bird = DockerOperator(
        ...
        api_version="auto",
        auto_remove=True,
        command=f"./provider_runtool.py --provider 'bird' --time-max '{time_max}' --time-min '{time_min}' --incomplete-only",
        docker_url="tcp://localhost:2376",
        network_mode="bridge",
        environment=environment_vars,
    )
    ...
    lyft = DockerOperator(
        ...
        api_version="auto",
        auto_remove=True,
        command=f"./provider_runtool.py --provider 'lyft' --time-max '{time_max}' --time-min '{time_min}' --incomplete-only",
        docker_url="tcp://localhost:2376",
        network_mode="bridge",
        environment=environment_vars,
    )
    ...
    wheels = DockerOperator(
        ...
        api_version="auto",
        auto_remove=True,
        command=f"./provider_runtool.py --provider 'wheels' --time-max '{time_max}' --time-min '{time_min}' --incomplete-only",
        docker_url="tcp://localhost:2376",
        network_mode="bridge",
        environment=environment_vars,
    )
    ...
    spin = DockerOperator(
        ...
        api_version="auto",
        auto_remove=True,
        command=f"./provider_runtool.py --provider 'spin' --time-max '{time_max}' --time-min '{time_min}' --incomplete-only",
        docker_url="tcp://localhost:2376",
        network_mode="bridge",
        environment=environment_vars,
    )
    ...
    ojo = DockerOperator(
        ...
        api_version="auto",
        auto_remove=True,
        command=f"./provider_runtool.py --provider 'ojo' --time-max '{time_max}' --time-min '{time_min}' --incomplete-only",
        docker_url="tcp://localhost:2376",
        network_mode="bridge",
        environment=environment_vars,
    )

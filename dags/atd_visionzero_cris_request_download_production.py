...
default_args = {
        'owner'                 : 'airflow',
        'description'           : 'Downloads files from email and extracts zip files (production).',
...
with DAG('atd_visionzero_cris_request_production', default_args=default_args, schedule_interval="0 1 * * *", catchup=False) as dag:

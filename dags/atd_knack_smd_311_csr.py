# test locally with: docker compose run --rm airflow-cli dags test atd_knack_signs_markings_311_csr
...
doc_md = """
## Knack Services DAG: SMD 311 Service requests

Publish signs markings 311 CSRs to Postgres, Socrata
...
with DAG(
    ...
    schedule="20 19 * * *" if DEPLOYMENT_ENVIRONMENT == "production" else None,

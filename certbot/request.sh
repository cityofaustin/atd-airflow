...
cat /etc/letsencrypt/live/airflow.austinmobility.io/cert.pem > /usr/local/etc/haproxy/ssl/airflow.austinmobility.io.pem

cat /etc/letsencrypt/live/airflow.austinmobility.io/privkey.pem >> /usr/local/etc/haproxy/ssl/airflow.austinmobility.io.pem